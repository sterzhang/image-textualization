...
class GRiTROIHeadsAndTextDecoder(CascadeROIHeads):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # local_model_path = "/home/zhangjianshu/.cache/huggingface/hub/bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594"
        # tokenizer = BertTokenizer.from_pretrained(local_model_path, do_lower_case=True, local_files_only=True)
